...
use turbopack_ecmascript::{
    ...
    transform::{PresetEnvConfig, RustReactCompilerCompilationMode},
};
...
pub struct EcmascriptOptionsContext {
    ...
    /// Experimental: use the Rust port of the React compiler (facebook/react#36173) before other
    /// transforms. `Some(mode)` enables it with the given compilation mode; `None` disables it.
    pub enable_rust_react_compiler: Option<RustReactCompilerCompilationMode>,
